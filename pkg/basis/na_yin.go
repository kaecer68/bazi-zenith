...
// NaYin represents the Na Yin Five Elements (納音五行)
type NaYin string

// NaYinNames maps the 60 Jiazi pillars to their Na Yin names.
var pillarNaYin = map[string]NaYin{
	...
	"甲辰": "佛燈火", "乙巳": "佛燈火", "丙午": "天河水", "丁未": "天河水", "戊申": "大驛土",
	"己酉": "大驛土", "庚戌": "釵釧金", "辛亥": "釵釧金", "壬子": "桑柘木", "癸丑": "桑柘木",
	"甲寅": "大溪水", "乙卯": "大溪水", "丙辰": "沙中土", "丁巳": "沙中土", "戊午": "天上火",
	"己未": "天上火", "庚申": "石榴木", "辛酉": "石榴木", "壬戌": "大海水", "癸亥": "大海水",
}

// GetNaYin returns the Na Yin name for a given Stem and Branch.
func GetNaYin(s Stem, b Branch) NaYin {
	key := fmt.Sprintf("%s%s", s, b)
	return pillarNaYin[key]
}
